...
if(isset($_POST['submit'])){
   ...
   if($select_users->rowCount() > 0){
      $warning_msg[] = 'e-mail já recebido!';
   }else{
      if($pass != $c_pass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="tel" name="name" required maxlength="50" placeholder="digite seu nome" class="box">
      <input type="email" name="email" required maxlength="50" placeholder="digite seu e-mail" class="box">
      <input type="number" name="number" required min="0" max="9999999999" maxlength="10" placeholder="coloque seu número" class="box">
      <input type="password" name="pass" required maxlength="20" placeholder="coloque sua senha" class="box">
      <input type="password" name="c_pass" required maxlength="20" placeholder="confirme sua senha" class="box">
      <p>já tem uma conta? <a href="login.html">Conecte-se agora</a></p>
