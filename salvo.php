   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>remover dos salvos</span></button>
            <?php
               }else{ 
            ?>
      ...
      <?php
         ...
         echo '<p class="empty">nenhuma propriedade salva ainda! <a href="listas.php" style="margin-top:1.5rem;" class="btn">descubra mais</a></p>';
      }
      ?>
