...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $success_msg[] = 'imóvel postado com sucesso!';
   }
...
<head>
   ...
   <title>postar propriedade</title>
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="insira o valor do depósito" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="quantos anos tem a propriedade?" class="input">
         </div>
         <div class="box">
            <p>andares totais <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="quantos pisos disponíveis?" class="input">
         </div>
         <div class="box">
            <p>andar do quarto <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="número do andar do imóvel" class="input">
         </div>
         <div class="box">
      ...
      <div class="box">
         ...
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="escreva sobre o imóvel..."></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
            <p><input type="checkbox" name="lift" value="yes" />elevadores</p>
            <p><input type="checkbox" name="security_guard" value="yes" />segurança</p>
         ...
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" />estacionamento</p>
            <p><input type="checkbox" name="gym" value="yes" />academia</p>
            <p><input type="checkbox" name="shopping_mall" value="yes" />centro de compras</p>
      ...
      <input type="submit" value="postar propriedade  " class="btn" name="post">
   </form>
