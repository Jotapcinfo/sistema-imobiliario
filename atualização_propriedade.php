...
if(isset($_POST['update'])){
   ...
   if(!empty($image_01)){
      if($image_01_size > 2000000){
         $warning_msg[] = 'o tamanho da imagem 01 é muito grande!';
      }else{
   ...
   if(!empty($image_02)){
      if($image_02_size > 2000000){
         $warning_msg[] = 'o tamanho da imagem 02 é muito grande!';
      }else{
   ...
   if(!empty($image_03)){
      if($image_03_size > 2000000){
         $warning_msg[] = 'o tamanho da imagem 03 é muito grande!';
      }else{
   ...
   if(!empty($image_04)){
      if($image_04_size > 2000000){
         $warning_msg[] = 'o tamanho da imagem 04 é muito grande!';
      }else{
   ...
   if(!empty($image_05)){
      if($image_05_size > 2000000){
         $warning_msg[] = 'o tamanho da imagem 05 é muito grande!';
      }else{
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="insira o nome da propriedade" value="<?= $fetch_property['property_name']; ?>" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>preço de propriedade <span>*</span></p>
         ...
         <div class="box">
            <p>valor do depósito <span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="insira o valor do depósito" class="input">
         </div>
         <div class="box">
            <p>endereço da propriedade <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="insira o endereço completo da propriedade" class="input" value="<?= $fetch_property['address']; ?>">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <select name="status" required class="input">
               ...
               <option value="pronto para mover">pronto para mover</option>
               <option value="em construção">em construção</option>
            </select>
         </div>
         <div class="box">
            <p>estado mobiliado <span>*</span></p>
         ...
         <div class="box">
            <p>quantos cômodos <span>*</span></p>
            <select name="bhk" required class="input">
               <option value="<?= $fetch_property['bhk']; ?>" selected><?= $fetch_property['bhk']; ?> cômodos</option>
               ...
               <option value="6">6 cômodos</option>
               <option value="7">7 cômodos</option>
               <option value="8">8 cômodos</option>
               <option value="9">9 cômodos</option>
            </select>
         </div>
         <div class="box">
            ...
            <select name="bedroom" required class="input">
               ...
               <option value="0">0 quarto</option>
         ...
         <div class="box">
            ...
            <select name="bathroom" required class="input">
               <option value="<?= $fetch_property['bathroom']; ?>" selected><?= $fetch_property['bathroom']; ?> banheiro</option>
         ...
         <div class="box">
            ...
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="quantos anos tem a propriedade?" class="input" value="<?= $fetch_property['age']; ?>">
         </div>
         <div class="box">
            <p>andares totais <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="como pisos disponíveis?" class="input" value="<?= $fetch_property['total_floors']; ?>">
         </div>
         <div class="box">
            <p>andar do quarto <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="número do andar do imóvel" class="input" value="<?= $fetch_property['room_floor']; ?>">
         </div>
         <div class="box">
      ...
      <div class="box">
         ...
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="escreva sobre o imóvel..." ><?= $fetch_property['description']; ?></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
            <p><input type="checkbox" name="lift" value="yes" <?php if($fetch_property['lift'] == 'yes'){echo 'verificado'; } ?> />elevadores</p>
            <p><input type="checkbox" name="security_guard" value="yes" <?php if($fetch_property['security_guard'] == 'yes'){echo 'verificado'; } ?> />segurança</p>
            <p><input type="checkbox" name="play_ground" value="yes" <?php if($fetch_property['play_ground'] == 'yes'){echo 'verificado'; } ?> />parque infantil</p>
            <p><input type="checkbox" name="garden" value="yes" <?php if($fetch_property['garden'] == 'yes'){echo 'verificado'; } ?> />jardim</p>
            <p><input type="checkbox" name="water_supply" value="yes" <?php if($fetch_property['water_supply'] == 'yes'){echo 'verificado'; } ?> />abastecimento de água</p>
            <p><input type="checkbox" name="power_backup" value="yes" <?php if($fetch_property['power_backup'] == 'yes'){echo 'verificado'; } ?> />backup de energia</p>
         </div>
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" <?php if($fetch_property['parking_area'] == 'yes'){echo 'verificado'; } ?> />estacionamento</p>
            <p><input type="checkbox" name="gym" value="yes" <?php if($fetch_property['gym'] == 'yes'){echo 'verificado'; } ?> />academia</p>
            <p><input type="checkbox" name="shopping_mall" value="yes" <?php if($fetch_property['shopping_mall'] == 'yes'){echo 'verificado'; } ?> />Centro de compras</p>
            <p><input type="checkbox" name="hospital" value="yes" <?php if($fetch_property['hospital'] == 'yes'){echo 'verificado'; } ?> />hospital</p>
            <p><input type="checkbox" name="school" value="yes" <?php if($fetch_property['school'] == 'yes'){echo 'verificado'; } ?> />escola</p>
            <p><input type="checkbox" name="market_area" value="yes" <?php if($fetch_property['market_area'] == 'yes'){echo 'verificado'; } ?> />área de mercado</p>
         </div>
      </div>
      <div class="box">
      ...
      <div class="flex"> 
         <div class="box">
            ...
            <input type="submit" value="excluir imagem 02" name="delete_image_02" class="inline-btn" onclick="return confirm('excluir imagem 02');">
            <?php } ?>
         ...
         <div class="box">
            ...
            <input type="submit" value="excluir imagem 03" name="delete_image_03" class="inline-btn" onclick="return confirm('excluir imagem 03');">
            <?php } ?>
         ...
         <div class="box">
            ...
            <input type="submit" value="excluir imagem 04" name="delete_image_04" class="inline-btn" onclick="return confirm('excluir imagem 04');">
            <?php } ?>
         ...
         <div class="box">
            ...
            <input type="submit" value="excluir imagem 05" name="delete_image_05" class="inline-btn" onclick="return confirm('excluir imagem 05');">
            <?php } ?>
   ...
   <?php
      ...
      echo '<p class="empty">imóvel não encontrado! <a href="postagem_propriedade.php" style="margin-top:1.5rem;" class="btn">adicionar novo</a></p>';
   }
   ?>
