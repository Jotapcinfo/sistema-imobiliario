...
<section class="filters" style="padding-bottom: 0;">
   ...
   <form action="" method="post">
      ...
      <h3>filtre sua pesquisa</h3>
         ...
         <div class="flex">
            <div class="box">
               <p>insira a localização</p>
               <input type="text" name="location" required maxlength="50" placeholder="digite um endereço ou cidade" class="input">
            </div>
            <div class="box">
               <p>tipo de oferta</p>
         ...
         <input type="submit" value="pesquisar propriedade" name="filter_search" class="btn">
   </form>
...
<section class="listings">
   ...
   <?php 
      if(isset($_POST['h_search']) or isset($_POST['filter_search'])){
         echo '<h1 class="heading">Resultados de pesquisa</h1>';
      }else{
