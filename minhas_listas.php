...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'anúncio deletado com sucesso!';
   }else{
      $warning_msg[] = 'listagem já excluída!';
   }
...
<section class="my-listings">
   ...
   <h1 class="heading">minhas listas</h1>
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="flex-btn">
         <a href="atualização_propriedade.php?get_id=<?= $property_id; ?>" class="btn">atualizar</a>
         <input type="submit" name="delete" value="deletar" class="btn" onclick="return confirm('excluir esta listagem?');">
      </div>
      <a href="ver_propriedade.php?get_id=<?= $property_id; ?>" class="btn">ver propriedade</a>
   </form>
   <?php
         }
      }else{
