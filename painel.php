...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <a href="atualização.php" class="btn">atualizar perfil</a>
      </div>

      <div class="box">
         <h3>pesquisa de filtro</h3>
         <p>Procure o imóvel dos seus sonhos</p>
         <a href="pesquisa.php" class="btn">procure agora</a>
      </div>
      ...
      <a href="minhas_listas.php" class="btn">ver todas as listas</a>
      </div>
      ...
      <a href="solicitações_recebidas.php" class="btn">Ver solicitações recebidas</a>
      </div>
      ...
      <a href="solicitações_enviadas.php" class="btn">Ver solicitações enviadas</a>
      </div>
      ...
      <a href="salvo.php" class="btn">ver propriedades salvas</a>
      </div>
