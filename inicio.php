...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="pesquisa.php" method="post">
         ...
         <div class="box">
            <p>insira a localização <span>*</span></p>
            <input type="text" name="h_location" required maxlength="100" placeholder="digite um endereço ou cidade" class="input">
         </div>
         <div class="flex">
            <div class="box">
         ...
         <input type="submit" value="Pesquisar Propriedades" name="h_search" class="btn">
      </form>
...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>apartamentos e prédios</h3>
         <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque, incidunt.</p>
      </div>

      <div class="box">
         <img src="images/icon-5.png" alt="">
         <h3>comércios e shoppings</h3>
         <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque, incidunt.</p>
      </div>
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><i class="fa-solid fa-brazilian-real-sign"></i><span><?= $fetch_property['price']; ?></span></div>
            <h3 class="name"><?= $fetch_property['property_name']; ?></h3>
            <p class="location"><i class="fas fa-map-marker-alt"></i><span><?= $fetch_property['address']; ?></span></p>
            <div class="flex">
               <p><i class="fas fa-house"></i><span><?= $fetch_property['type']; ?></span></p>
               <p><i class="fas fa-tag"></i><span><?= $fetch_property['offer']; ?></span></p>
               <p><i class="fas fa-bed"></i><span><?= $fetch_property['bhk']; ?> cômodos</span></p>
      ...
      <?php
         ...
         echo '<p class="empty">nenhuma propriedade adicionada ainda! <a href="postagem_propriedade.php" style="margin-top:1.5rem;" class="btn">adicionar novo</a></p>';
      }
      ?>
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="listas.php" class="inline-btn">ver tudo</a>
   </div>
