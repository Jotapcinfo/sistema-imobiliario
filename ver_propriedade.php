...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-brazilian-real-sign"></i><span><?= $fetch_property['price']; ?></span></p>
         <p><i class="fas fa-user"></i><span><?= $fetch_user['name']; ?></span></p>
         <p><i class="fas fa-phone"></i><a href="tel:11915813527"><?= $fetch_user['number']; ?></a></p>
      ...
      <div class="flex">
         <div class="box">
            <p><i>cômodos :</i><span><?= $fetch_property['bhk']; ?></span></p>
            <p><i>valor do depósito : </i><span><span class="fa-solid fa-brazilian-real-sign" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
            <p><i>status :</i><span><?= $fetch_property['status']; ?></span></p>
            <p><i>quarto :</i><span><?= $fetch_property['bedroom']; ?></span></p>
            <p><i>banheiro :</i><span><?= $fetch_property['bathroom']; ?> </span></p>
            <p><i>sacada :</i><span><?= $fetch_property['balcony']; ?></span></p>
         </div>
         <div class="box">
            <p><i>área de carpete :</i><span><?= $fetch_property['carpet']; ?>m2</span></p>
            <p><i>idade :</i><span><?= $fetch_property['age']; ?> anos</span></p>
            <p><i>andares totais :</i><span><?= $fetch_property['total_floors']; ?></span></p>
            <p><i>andar do quarto :</i><span><?= $fetch_property['room_floor']; ?></span></p>
            <p><i>mobília :</i><span><?= $fetch_property['furnished']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['lift'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>elevadores</span></p>
            <p><i class="fas fa-<?php if($fetch_property['security_guard'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>seguranças</span></p>
            <p><i class="fas fa-<?php if($fetch_property['play_ground'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>parque infantil</span></p>
         ...
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['parking_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>estacionamento</span></p>
            <p><i class="fas fa-<?php if($fetch_property['gym'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>academia</span></p>
            <p><i class="fas fa-<?php if($fetch_property['shopping_mall'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Centro de compras</span></p>
      ...
      <form action="" method="post" class="flex-btn">
         ...
         ?>
         <input type="submit" value="enviar solicitação(Parceiro)" name="send" class="btn">
      </form>
   </div>
   <?php
      }
