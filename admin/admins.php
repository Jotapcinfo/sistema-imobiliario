...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Administrador deletado!';
   }else{
      $warning_msg[] = 'O administrador já excluiu!';
   }
...
<section class="grid">
   ...
   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="procure administradores..." maxlength="100" required>
   ...
   <div class="box" style="order: -1;">
      ...
      <a href="atualização.php" class="option-btn">Atualizar conta</a>
      <a href="registro.php" class="btn">Registrar novo</a>
   </div>
   <?php }else{?>
   <div class="box">
      <p>nome : <span><?= $fetch_admins['name']; ?></p>
   ...
   ?>
      <p class="empty">Nenhum administrador adicionado ainda!</p>
      <div class="box" style="text-align: center;">
      <p>Criar um novo administrador</p>
      <a href="registro.php" class="btn">Registrar agora</a>
   </div>
   <?php
      }
   ?>
