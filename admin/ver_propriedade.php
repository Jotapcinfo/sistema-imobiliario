...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Listagem deletada!';
   }else{
      $warning_msg[] = 'Listagem já deletada!';
   }
...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="flex">
         <div class="box">
            <p><i>cômodos :</i><span><?= $fetch_property['bhk']; ?> cômodos</span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i class="fas fa-<?php if($fetch_property['security_guard'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>segurança</span></p>
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <input type="submit" value="excluir propriedade" name="delete" class="delete-btn" onclick="return confirm('excluir esta listagem?');">
      </form>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">imóvel não encontrado! <a href="listas.php" style="margin-top:1.5rem;" class="option-btn">ir para listagens</a></p>';
   }
   ?>
