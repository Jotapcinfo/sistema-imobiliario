...
<section class="grid">
   ...
   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="pesquisar usuários..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="deletar usuário" onclick="return confirm('excluir este usuário?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
      }
      ...
      echo '<p class="empty">nenhuma conta de usuário adicionada ainda!</p>';
   }
   ?>
