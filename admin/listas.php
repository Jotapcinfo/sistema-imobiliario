...
<section class="listings">
   ...
   <h1 class="heading">todas as listas</h1>

   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="listas de pesquisa..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <p class="price"><i class="fa-solid fa-brazilian-real-sign"></i><?= $fetch_listing['price']; ?></p>
      ...
      <form action="" method="POST">
         ...
         <a href="ver_propriedade.php?get_id=<?= $listing_id; ?>" class="btn">ver propriedade</a>
         <input type="submit" value="excluir listagem" onclick="return confirm('excluir esta listagem?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
         }
         ...
         echo '<p class="empty">nenhum imóvel anunciado ainda!</p>';
      }
   ?>
