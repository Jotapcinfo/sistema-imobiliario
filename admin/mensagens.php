...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Mensagem apagada!';
   }else{
      $warning_msg[] = 'Mensagem já apagada!';
   }
...
<section class="grid">
   ...
   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="pesquisar mensagens..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="excluir mensagem" onclick="return confirm('excluir esta mensagem?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
      }
